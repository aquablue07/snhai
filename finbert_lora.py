...
def tokenize_and_format(examples):
    ...
    tokenized = tokenizer(
        examples["input_text"], max_length=256, padding="max_length", truncation=True
    )
...
# LoRA Config - Added for efficiency
...
training_args = TrainingArguments(
    ...
    learning_rate=2e-5,
    evaluation_strategy="epoch", # CORRECTED: Renamed from eval_strategy
    save_strategy="epoch",
    logging_dir="./logs",
